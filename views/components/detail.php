...
<div class="movie-detail">
	...
	<div class="movie-age-wrapper">
		<div class="movie-original-title"><?= $movie['original-title'] ?></div>
		<div class="movie-age"><?= $movie['age-restriction'] . "+" ?></div>
	</div>
	<div class="movie-detail-content">
		<div class="movie-img" style="background-image: url('../../assets/images/<?= $movie['id'] ?>.jpg');"></div>
		<div class="movie-detail-info">
			<div class="movie-rating">
				<?php for ($key = 1; $key <= 10; $key++): ?>
					<?= createRatingSquares($key, $movie['rating']) ?>
				<?php endfor; ?>
			...
			<div class="movie-about-wrapper">
				...
				<div class="movie-about-desc-wrapper">
					...
					<div class="movie-about-desc detail-text-s-black"><?= $movie['director'] ?></div>
